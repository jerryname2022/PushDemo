...
public class AdvancedWebView extends WebView {
    ...
    protected void init(Context context) {
        ...
        super.setWebViewClient(new WebViewClient() {
            ...
            public void onUnhandledInputEvent(WebView view, InputEvent event) {
                if (Build.VERSION.SDK_INT >= 21) {
                    if (mCustomWebViewClient != null) {
                        //TODO  mCustomWebViewClient.onUnhandledInputEvent(view, event);
                    } else {
                        //TODO  super.onUnhandledInputEvent(view, event);
                    }
                }
            }
        ...
        super.setWebChromeClient(new WebChromeClient() {
            ...
            public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType, String capture) {
                openFileInput(uploadMsg, null, acceptType, capture);
            }
            ...
            public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback, WebChromeClient.FileChooserParams fileChooserParams) {
                if (Build.VERSION.SDK_INT >= 21) {
                    openFileInput(null, filePathCallback, fileChooserParams);
                    return true;
                } else {
                    return false;
                }
    ...
    protected void openFileInput(final ValueCallback<Uri> fileUploadCallbackFirst, final ValueCallback<Uri[]> fileUploadCallbackSecond, String acceptType, String capture) {

    }

    @SuppressLint("NewApi")
    protected void openFileInput(final ValueCallback<Uri> fileUploadCallbackFirst, final ValueCallback<Uri[]> fileUploadCallbackSecond, final WebChromeClient.FileChooserParams fileChooserParams) {
        if (mFileUploadCallbackFirst != null) {
            mFileUploadCallbackFirst.onReceiveValue(null);
        }
